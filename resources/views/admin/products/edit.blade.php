...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('Products')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ @lang('Edit a Product') </span>
            </div>
        </div>
                ...
                <div class="card-body pt-0">
                    <div class="">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="title" value="{{ old('title', $item->title) }}" placeholder="@lang('Enter product title')">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_title" class="form-control" id="sub_title" value="{{ old('sub_title', $item->sub_title) }}" placeholder="@lang('Enter product Sub Title')">
                            @error('sub_title')
                                <small class="text-danger d-block">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="button_name" class="form-control" id="button_name" value="{{ old('button_name', $item->button_name) }}" placeholder="@lang('Enter product button name')">
                            @error('button_name')
                                <small class="text-danger d-block">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="url" name="url" class="form-control" id="url" value="{{ old('url', $item->url) }}" placeholder="@lang('Enter product URL')">
                            @error('url')
                                <small class="text-danger d-block">{{ $message }}</small>
                            @enderror
                        </div>
            ...
            <div class="card  box-shadow-0  h-100">
                ...
                <div class="card-body pt-0">
                    <div class="form-group">
                        ...
                        <input type="number" name="sort" class="form-control" id="sort" value="{{ old('sort', $item->sort) }}" placeholder="@lang('Enter product sort')">
                        @error('sort')
                            <small class="text-danger d-block">{{ $message }}</small>
                        @enderror
                    </div>
