...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('Products')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ @lang('Create a New Product') </span>
            </div>
        </div>
    ...
    <!-- row opened -->
    <form action="{{ route('products.store') }}" method="post" class="row row-sm" enctype="multipart/form-data">
        @csrf
        <div class="col-md-6 ">
                ...
                <div class="card-body pt-0">
                    <div class="">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name" value="{{ old('name') }}" placeholder="@lang('Enter product name')">
                            @error('name')
        ...
        <div class="col-md-6">
            <div class="card  box-shadow-0  h-100">
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control">
                                    <option>@lang('Select an Item')</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step=".5" name="price_before_discount" class="form-control" id="price_before_discount" value="{{ old('price_before_discount') }}" placeholder="@lang('Enter product price before discount')">
                                @error('price_afrer_discount')
                                    <small class="text-danger d-block">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step=".5" name="price_after_discount" class="form-control" id="price_after_discount" value="{{ old('price_after_discount') }}" placeholder="@lang('Enter product price after discount')">
                                @error('price_afrer_discount')
                                    <small class="text-danger d-block">{{ $message }}</small>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        <label for="price_before_discount">@lang('Image')</label>
