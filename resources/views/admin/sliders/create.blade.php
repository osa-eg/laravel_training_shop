...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('Sliders')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ @lang('Create a New Slider') </span>
            </div>
        </div>
    ...
    <!-- row opened -->
    <form action="{{ route('sliders.store') }}" method="post" class="row row-sm" enctype="multipart/form-data">
        @csrf
        <div class="col-md-6 ">
                ...
                <div class="card-body pt-0">
                    <div class="">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="title" value="{{ old('title') }}" placeholder="@lang('Enter slider title')">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="button_name" class="form-control" id="button_name" value="{{ old('button_name') }}" placeholder="@lang('Enter slider button name')">
                            @error('button_name')
                                <small class="text-danger d-block">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="url" name="url" class="form-control" id="url" value="{{ old('url') }}" placeholder="@lang('Enter slider URL')">
                            @error('url')
                                <small class="text-danger d-block">{{ $message }}</small>
                            @enderror
                        </div>
            ...
            <div class="card  box-shadow-0  h-100">
                ...
                <div class="card-body pt-0">
                    <div class="form-group">
                        ...
                        <input type="number" name="sort" class="form-control" id="sort" value="{{ old('sort') }}" placeholder="@lang('Enter slider sort')">
                        @error('sort')
                            <small class="text-danger d-block">{{ $message }}</small>
                        @enderror
                    </div>
