                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-slick">
                            <div><img src="{{ asset("website/assets/images/pro3/1.jpg")}}" alt="" class="img-fluid blur-up lazyload image_zoom_cls-0">
                            </div>
                            <div><img src="{{ asset("website/assets/images/pro3/2.jpg")}}" alt="" class="img-fluid blur-up lazyload image_zoom_cls-1"></div>
                            <div><img src="{{ asset("website/assets/images/pro3/27.jpg")}}" alt="" class="img-fluid blur-up lazyload image_zoom_cls-2"></div>
                            <div><img src="{{ asset("website/assets/images/pro3/27.jpg")}}" alt="" class="img-fluid blur-up lazyload image_zoom_cls-3"></div>
                        </div>
                        <div class="row">
                            <div class="col-12 p-0">
                                <div class="slider-nav">
                                    <div><img src="{{ asset("website/assets/images/pro3/1.jpg")}}" alt="" class="img-fluid blur-up lazyload"></div>
                                    <div><img src="{{ asset("website/assets/images/pro3/2.jpg")}}" alt="" class="img-fluid blur-up lazyload"></div>
                                    <div><img src="{{ asset("website/assets/images/pro3/27.jpg")}}" alt="" class="img-fluid blur-up lazyload"></div>
                                    <div><img src="{{ asset("website/assets/images/pro3/27.jpg")}}" alt="" class="img-fluid blur-up lazyload"></div>
                                </div>
                            </div>
                        </div>
                        <div class="image-360" data-bs-toggle="modal" data-bs-target="#product-modal">
                            <img src="//cdn.shopify.com/s/files/1/0032/3279/2674/t/84/assets/360-icon.png?v=3119721003530142722" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            <div class="product-count">
                                <ul>
                                    <li>
                                        <img src="{{ asset("website/assets/images/fire.gif")}}" class="img-fluid" alt="image">
                                        <span class="p-counter">37</span>
                                        <span class="lang">orders in last 24 hours</span>
                                    </li>
                                    <li>
                                        <img src="{{ asset("website/assets/images/person.gif")}}" class="img-fluid user_img" alt="image">
                                ...
                                <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body"><img src="{{ asset("website/assets/images/size-chart.jpg")}}" alt="" class="img-fluid blur-up lazyload"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product-buttons"><a href="javascript:void(0)" id="cartEffect" class="btn btn-solid hover-solid btn-animation"><i class="fa fa-shopping-cart me-1" aria-hidden="true"></i> add to cart</a> <a href="#" class="btn btn-solid"><i class="fa fa-bookmark fz-16 me-2" aria-hidden="true"></i>wishlist</a></div>
                            <div class="product-count">
                                <ul>
                                    <li>
                                        <img src="{{ asset("website/assets/images/icon/truck.png")}}" class="img-fluid" alt="image">
            ...
            <div class="row search-product">
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="{{ asset("website/assets/images/pro3/33.jpg")}}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="{{ asset("website/assets/images/pro3/34.jpg")}}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="{{ asset("website/assets/images/pro3/1.jpg")}}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="{{ asset("website/assets/images/pro3/2.jpg")}}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a>
                            </div>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="{{ asset("website/assets/images/pro3/27.jpg")}}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="{{ asset("website/assets/images/pro3/28.jpg")}}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a>
                            </div>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="{{ asset("website/assets/images/pro3/35.jpg")}}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="{{ asset("website/assets/images/pro3/36.jpg")}}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a>
                            </div>
